...
const projects: Project[] = [
  ...
  // +
  {
    // 01. Hermes Beach Resort project
    id: "hermesbeachresort",
    category: "Hotels and Resorts",
    title: "Hermes Beach Resort",
    src: "/assets/projects-screenshots/hermesbeachresort/1.png",
    screenshots: ["1.png"],
    live: "https://hermes-beach-resort.vercel.app/",
    github: "https://github.com/SamruddhiShinde-hub/hermes-beach-resort",
    skills: {
      frontend: [
    ...
    get content() {
      return (
        <div>
          <TypographyP className='font-mono '>
            Hermes Beach Resort - A beautiful beach resort website showcasing
            accommodations, amenities, and booking options for a luxurious
            beachside getaway experience.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow images={[`${BASE_PATH}/hermesbeachresort/1.png`]} />
        </div>
      );
    },
  },
  {
    // 02. Bruma Coffee Shop project
    id: "brumacoffeeshop",
    category: "Web Development",
    title: "Bruma Coffee Shop",
    src: "/assets/projects-screenshots/brumacoffeeshop/1.png",
    screenshots: ["/assets/projects-screenshots/brumacoffeeshop/1.png"],
    skills: {
      frontend: [
        PROJECT_SKILLS.react,
        PROJECT_SKILLS.github,
    ...
    live: "https://bruma-coffee-shop-website.vercel.app/",
    github: "https://github.com/SamruddhiShinde-hub/bruma-coffee-shop-website",
    get content() {
      return (
        <div>
          <TypographyP className='font-mono '>
  ...
  {
    // 03. Arthani Wealth project
    id: "arthaniwealth",
    category: "Finance",
    title: "Arthani Wealth",
    src: "/assets/projects-screenshots/arthaniwealth/1.png",
    screenshots: ["1.png"],
    ...
    get content() {
      return (
        <div>
          ...
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow images={[`${BASE_PATH}/arthaniwealth/1.png`]} />
        </div>
      );
    },
  },
